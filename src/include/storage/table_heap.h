...
class TableHeap {
 ...
 public:
  ...
  inline void SetFirstPageId(page_id_t first_page_id) { first_page_id_ = first_page_id; }

  inline void SetNextFreePageId(page_id_t next_free_page_id) { next_free_page_id_ = next_free_page_id; }
...
private:
 ...
 private:
  ...
  page_id_t next_free_page_id_ = INVALID_PAGE_ID;
  Schema *schema_;
